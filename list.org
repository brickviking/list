...
This was split off into its own file because it seems to be causing some issues for the watcom compile that I can't track down.
...
* DOS
So far, this needs pdcurses. There's other work to do to get it to work under Watcom.
