...
which were added to show compile status for the project on my own machine. I don't have NetBSD or
Solaris installed at the moment, and I don't see me getting to them in the near future. However,
I have compiled them on the rest of the operating systems I state. Your mileage might vary for
cygwin or WSL, but it's worth a try.
