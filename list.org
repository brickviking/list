...
This needs to be turned into MSDOS-guacamole, i.e. with ^M at the ends of every line. This also
needs tabs where they need to be, I should have modified them in previous makefiles too.
...
OBJECTS = list.obj dequeue.obj bugwrite.obj screen.obj file.obj input.obj

all: list

.c.obj:
	$(CC) $(CFLAGS) $(OPTFLAGS) $(INCDIR)
...
dequeue.obj: dequeue.c
	$(CC) $(CFLAGS) $(OPTFLAGS) $(INCDIR)

bugwrite.obj: bugwrite.c
	$(CC) $(CFLAGS) $(OPTFLAGS) $(INCDIR)
