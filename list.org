...
Putting back the debug stuff into Watcom's response file requires a separate response file for the debug objects.
#+BEGIN_SRC linker -i
system dos4g
name listd.exe
option map
file { listd.obj dequeued.obj bugwrited.obj filed.obj inputd.obj showhelpd.obj screend.obj }
library { c:\pdcurses\dos\pdcurses.lib }
#+END_SRC
...
DBGOBJECTS = listd.obj dequeued.obj bugwrited.obj filed.obj inputd.obj showhelpd.obj screend.obj
