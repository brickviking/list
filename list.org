...
* Documentation
Yup, docs are pretty much required, so I provide a man page here written in nroff and perhaps
...
** Man page
   :PROPERTIES: header-args :tangle list.1
   :END:
...
.\"
.\"
.TH LIST 1 "19th May 2021" "List" \" -*- nroff -*-
.SH NAME
...
** Readme file
   :PROPERTIES: header-args :tangle ../README.md
   :END:
#+BEGIN_SRC markdown
...
** bugwrite.c
   :PROPERTIES: header-args :tangle bugwrite.c
   :END:
...
#+END_SRC
** dequeue.c
   :PROPERTIES: header-args :tangle dequeue.c
   :END:
...
#+END_SRC
** dequeue.h
   :PROPERTIES: header-args :tangle dequeue.h
   :END:
...
#+END_SRC
** dirbrowse.c
   :PROPERTIES: header-args :tangle dirbrowse.c
   :END:
...
#+END_SRC
** filebrowse.c
   :PROPERTIES: header-args :tangle filebrowse.c
   :END:
...
#+END_SRC
** file.c
   :PROPERTIES: header-args :tangle file.c
   :END:

Not quite sure what this was meant to be.
#+BEGIN_SRC c
...
#+END_SRC
** input.c
   :PROPERTIES: header-args :tangle input.c
   :END:
...
** screen.c
   :PROPERTIES: header-args :tangle screen.c
   :END:

These are functions that deal with anything goisng to the screen through ncurses.
#+BEGIN_SRC c
...
/*  wmove(HelpWin, 0,18); */
  ...
  if(EightBitDisplay) {
    ...
    mvwaddstr(HelpWin, y++, x, "                 ±±   ±±   ±      ﬂ     ±±       Eric Gillespie             ");  /* Ln 3 */
    mvwaddstr(HelpWin, y++, x, "                 ≤≤   ≤≤    ≤≤≤≤≤≤      ≤≤                                  ");  /* Ln 4 */
    mvwaddstr(HelpWin, y++, x, "                 ≤≤   ≤≤   ‹      ≤     ≤≤                                  ");  /* Ln 5 */
    mvwaddstr(HelpWin, y++, x, "                 €€   €€   ﬂ€€€€€€ﬂ     €€                                  ");  /* Ln 6 */
...
/* Here's one solution...keyed off LINES (a constant of ncurses) */
  ...
  if(EightBitDisplay) {
    mvwaddstr(HelpWin, y++, x, "⁄ƒƒƒƒƒ¬ƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒø"); /* Ln 13 */
    mvwaddstr(HelpWin, y++, x, "≥ Key ≥ Mode ≥         Action         ≥  Key  ≥ Mode ≥       Action          ≥"); /* Ln 14 */
    mvwaddstr(HelpWin, y++, x, "√ƒƒƒƒƒ¬ƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¥"); /* Ln 15 */
...
/*    mvwaddstr(HelpWin, x++, y, "≥ Up (j) ≥  16 bytes   ≥    One line backward       ≥(E)nd ≥    End of file    ≥"); / * Ln 17 */
    ...
    x = 1;  /* Reset back to the left of the screen plus one for balancing */
    mvwaddstr(HelpWin, y, x,   "¿ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒŸ"); /* Ln 25 */
...
/*    wclear(HelpWin); */
    ...
    y = 0, x = 1;
    if(EightBitDisplay) {
      mvwaddstr(HelpWin, y++, x, "⁄ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒø"); /* Ln 1 */
      mvwaddstr(HelpWin, y++, x, "≥                               Other keys                                   ≥"); /* Ln 2 */
      mvwaddstr(HelpWin, y++, x, "√ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¥"); /* Ln 3 */
...
/*  wmove(StatWin, y++, x); */
  if(EightBitDisplay)  {
    mvwaddstr(StatWin, y++, x, "⁄ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒø"); /* Ln 0 */
/*     wmove(StatWin, y++, x); */
    ...
    x = 0;
    mvwaddstr(StatWin, y++, x, "√ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¥"); /* Ln 2 */
    ...
    x = 0;
    mvwaddstr(StatWin, y++, x, "√ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¥"); /* Ln 15 */
/*    sprintf(tempstring,  "≥                "); */
    ...
    mvwaddstr(StatWin, y++, x,                                         "               ≥");  /* Ln 16 */
    x = 0;
    mvwaddstr(StatWin, y++, x, "¿ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒŸ"); /* Ln 17 */
  }
  else  {
...
* Main program
** list.c
   :PROPERTIES: header-args :tangle list.c
   :END:
...
char    squaretop=" 218 ⁄ƒƒƒƒƒ¬ƒƒƒø 191 ";
char     whatever=" 179 ≥ 196 194 ≥ 179 ";
char   squarejoin=" 195 √ 197 ≈   ¥ 180";
char   squareside=" 179 ≥ 193     ≥ ";
char squarebottom=" 192 ¿ƒƒ¡ƒƒƒƒƒƒŸ 217";
}
*/

#+END_SRC
** list.h
   :PROPERTIES: header-args :tangle list.h
   :END:
...
** BSDMakefile
   :PROPERTIES: header-args :tangle BSDMakefile
   :END:
#+BEGIN_SRC make
DEBUGFLAGS = -g -O2
CC = gcc
...
** Gnu Makefile
   :PROPERTIES: header-args :tangle Makefile
   :END:
#+BEGIN_SRC make
DEBUGFLAGS = -g -O2
ifeq ($(OS), minix)
